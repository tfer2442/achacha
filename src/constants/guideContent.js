...
export const guideSteps = [
  // Step 1: 초기 화면
  {
    ...
    subText2: '놓치셨다구요?',
    image: require('src/assets/images/giftbox1.png'),
  ...
  // Step 2: 이미지 업로드
  {
    ...
    subText2: '자동 인식',
    image: require('src/assets/images/giftscan.png'),
  },
  // Step 3: 유효기간 알림
  {
    title: '유효기간 임박?',
    ...
    subText2: '알려드릴게요.',
    image: require('src/assets/images/bell.png'),
  ...
  // Step 4: 기프티콘 전달
  {
    ...
    subText2: '',
    image: require('src/assets/images/gesture.png'),
  },
  // Step 5: 쉐어박스
  {
    title: '연인도, 가족도, 친구도.',
    ...
    subText2: '',
    image: require('src/assets/images/share.png'),
  },
];
